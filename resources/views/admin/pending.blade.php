                                                    ...
                                                    @foreach($pendings as $pending)
                                                        <tr>
                                                            ...
                                                            <td class="row-actions">
                                                                ...
                                                                <a href="{{ route('admin.deposit.create', $pending_id = $pending->id) }}">
                                                                    ...
                                                                    <div class="modal fade" id="exampleModal-{{ $pending->id }}" tabindex="-1" aria-labelledby="exampleModalLabel-{{ $pending->id }}" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <a href="{{ route('admin.deposit.restrict', $pending_id = $pending->id) }}" class="btn btn-primary">Delete Deposit</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
