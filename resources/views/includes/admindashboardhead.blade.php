        ...
        <meta name="description" content="Pallipenny is a community of people who are interested in making money with Bitcoin and other crypto-currency opportunities. Learn how to profit from digital currencies.">
        <meta content="width=device-width,initial-scale=1" name="viewport">
        <meta property="og:image" content="{{ asset('img/fb.png') }}">
        <meta property="twitter:image" content="{{ asset('img/fb.png') }}" />
        <meta property="og:image" content="{{ asset('img/fb.png') }}">
        <meta property="og:url" content="https://pallipeny.com">
        ...
        <link href="{{ asset('admin/css/main.css?version=4.5.0') }}" rel="stylesheet">
            ...
            /* Chart.js */
                @keyframes chartjs-render-animation{
                    ...
                    .chartjs-render-monitor{
                        ...
                        .chartjs-size-monitor,.chartjs-size-monitor-expand,.chartjs-size-monitor-shrink{position:absolute;direction:ltr;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1}.chartjs-size-monitor-expand>div{position:absolute;width:1000000px;height:1000000px;left:0;top:0}.chartjs-size-monitor-shrink>div{position:absolute;width:200%;height:200%;left:0;top:0}
        </style>